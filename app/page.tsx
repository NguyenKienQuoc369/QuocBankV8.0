...
// 2. Logo chạy vô tận (Infinite Marquee)
function PartnerMarquee() {
  const partners = ["GALAX_CORP", "STAR_LINK", "NEBULA_PAY", "QUANTUM_VC", "ORBIT_TECH", "VOID_BANK", "SOLAR_ENERGY"]
  return (
    <div className="w-full overflow-hidden py-10 border-y border-white/5 bg-black/20 backdrop-blur-sm">
      <motion.div 
      ...
      >
        {[...partners, ...partners].map((p, i) => (
          <div key={i} className="text-2xl font-bold text-gray-600 uppercase tracking-widest hover:text-[#00ff88] transition-colors cursor-default">
            {p}
          </div>
        ))}
      </motion.div>
  ...
  return (
    <div ref={targetRef} className="min-h-screen flex flex-col font-sans text-white relative overflow-x-hidden selection:bg-[#00ff88] selection:text-black">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 px-6 py-4 transition-all duration-300">
        <div className="max-w-7xl mx-auto flex items-center justify-between bg-black/20 backdrop-blur-xl border border-white/5 rounded-full px-6 py-3 shadow-2xl">
          ...
          <div className="flex items-center gap-3">
             <Link href="/login" className="hidden md:block text-xs font-bold px-4 py-2 hover:text-[#00ff88] transition-colors">ĐĂNG NHẬP</Link>
             <Link href="/register">
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center w-full">
          ...
          <motion.div style={{ y: yHero, opacity: opacityHero }} className="flex flex-col gap-8 text-center lg:text-left z-20">
            <FloatingElement duration={4}>
              <div className="inline-flex items-center gap-3 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-xs font-mono text-[#00ff88] backdrop-blur-md">
            ...
            <div>
              <h1 className="text-6xl lg:text-8xl font-black tracking-tighter leading-[0.9] mb-4 text-shadow-glow">
                <div className="text-white mb-2">NGÂN HÀNG</div>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-5 w-full sm:w-auto justify-center lg:justify-start">
              ...
              <button className="w-full sm:w-auto px-8 py-4 rounded-2xl bg-white/5 border border-white/10 hover:bg-white/10 backdrop-blur-md font-semibold flex items-center justify-center gap-3 transition-all group">
                <PlayCircle size={20} className="group-hover:text-[#00ff88] transition-colors"/> XEM DEMO
              </button>
            </div>
          ...
          <div className="hidden lg:block h-[600px]"></div> {/* Space for 3D Background */}
        </div>
      ...
      <section id="Tính năng" className="relative z-10 py-32">
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-20 text-center">
            <h2 className="text-4xl lg:text-6xl font-bold mb-6">CÔNG NGHỆ <span className="text-[#00ff88]">LÕI</span></h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[350px]">
            ...
            <motion.div whileHover={{ y: -5 }} className="md:col-span-2">
               <SpotlightCard className="h-full group bg-black/40" spotlightColor="rgba(79, 70, 229, 0.3)">
                 <div className="absolute top-0 right-0 w-96 h-96 bg-indigo-500/10 rounded-full blur-[100px] opacity-50"></div>
            ...
            <motion.div whileHover={{ y: -5 }}>
               <SpotlightCard className="h-full bg-black/40" spotlightColor="rgba(0, 255, 136, 0.3)">
            ...
            {/* Card 3: Global */}
            <motion.div whileHover={{ y: -5 }}>
               <SpotlightCard className="h-full bg-black/40" spotlightColor="rgba(6, 182, 212, 0.3)">
                 <div className="p-8 h-full flex flex-col justify-between">
            ...
            {/* Card 4: Virtual Card */}
            <motion.div whileHover={{ y: -5 }} className="md:col-span-2">
               <SpotlightCard className="h-full bg-black/40" spotlightColor="rgba(255, 255, 255, 0.2)">
      ...
      {/* 6. APP SHOWCASE (New Section) */}
      <section id="Ứng dụng" className="relative z-10 py-32 bg-gradient-to-b from-transparent to-black/80">
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
           ...
           >
              ...
              {/* Vòng tròn trang trí sau điện thoại */}
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] border border-white/5 rounded-full -z-10 animate-spin-slow"></div>
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] border border-[#00ff88]/20 rounded-full -z-10 animate-spin-reverse-slow"></div>
           </motion.div>
           ...
           <div className="space-y-8">
              ...
              <p className="text-gray-400 text-lg">
                 Truy cập tài khoản mọi lúc, mọi nơi - kể cả khi bạn đang ở trạm vũ trụ ISS hay bề mặt Sao Hỏa. Ứng dụng QuocBank Mobile được thiết kế tối ưu cho môi trường không trọng lực.
              </p>
              ...
              <div className="flex gap-4 pt-4">
                 ...
                 <button className="px-6 py-3 bg-white/10 text-white border border-white/10 rounded-xl font-bold flex items-center gap-2 hover:bg-white/20 transition-colors">
      ...
      {/* 7. TESTIMONIALS (Truyền tin từ không gian) */}
      <section className="relative z-10 py-32 border-t border-white/5">
         <div className="max-w-7xl mx-auto px-6">
            <h2 className="text-center text-4xl font-bold mb-16">Truyền Tin Từ Khách Hàng</h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
               {[
                  ...
                  <SpotlightCard key={i} className="bg-white/5 p-8" spotlightColor="rgba(255, 255, 255, 0.1)">
      ...
      <footer className="relative z-10 bg-black pt-20 pb-10 px-6 border-t border-white/10">
          <div className="max-w-4xl mx-auto text-center mb-20">
             <h2 className="text-5xl font-bold mb-6">Sẵn sàng cất cánh?</h2>
