...
/**
 * =================================================================================================
 * PROJECT: QUOCBANK INTERSTELLAR - CITIZENSHIP PROCESSING UNIT (REGISTER V12.2)
 * STATUS: FIXED TYPE ERROR (Strict Mode Compatible)
 * COMPLEXITY: EXTREME
 * -------------------------------------------------------------------------------------------------
 * MODULES:
...
// =============================================================================
// SECTION 2: ANIMATION VARIANTS (FIXED TYPES)
// =============================================================================
...
// FIX LỖI TẠI ĐÂY: Thêm 'as const' vào type: "spring"
